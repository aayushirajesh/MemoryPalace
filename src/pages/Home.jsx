...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center px-5 sm:px-6 pt-12 sm:pt-25 text-center max-w-6xl mx-auto relative z-10 select-none">
      ...
      <p className="font-serif text-sm sm:text-base text-stone-400 max-w-2xl mt-8 sm:mt-10 leading-relaxed font-light px-2">
        {user
      ...
      <p className="mt-5 italic text-primaryText/70 text-xs sm:text-base font-serif tracking-wider sm:tracking-[0.12em] px-4">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 mt-15 w-full sm:w-auto">
      ...
      {/* Features */}
      <div className="w-full max-w-3xl mt-14 sm:mt-12 pt-10 mb-12 sm:pt-12 border-t border-white/5">
